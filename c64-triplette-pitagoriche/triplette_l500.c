...
unsigned int buf1[2000*3];
unsigned int buf2[2000*3];
...
void main() {   
   ...
   buf_read  = buf1;  // crea buffer di lettura per almeno 2000 triplette
   buf_write = buf2;  // crea buffer di scrittura per almeno 2000 triplette
