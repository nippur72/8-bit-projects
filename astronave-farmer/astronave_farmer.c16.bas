...
1 rem "Digitato e adattato al C16 da Antonino Porcino, Luglio 2019"
...
5 print cl$;"{yellow}";
6 print chr$(14):color 0,1,1:color 4,1,1
10 goto 500
20 input "COSA DEVO FARE{yellow}";fr$:print "{yellow}":x=0:y=0
